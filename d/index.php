...
if ($iRelease == 0)
{
	HTMLStart ('Download');
	Menu ('Download');
	print ('<h1>Download apoplexy 3.14.1</h1>');
} else {
	SetRelease ($iRelease);
...
<a href="/releases/apoplexy-3.14.1-win32.zip" class="download">Download Now</a>
</span>
...
<a href="/releases/apoplexy-3.14.1.tar.gz" class="download">Download Now</a>
</span>
