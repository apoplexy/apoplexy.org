...
if ($iRelease == 0)
{
	HTMLStart ('Download');
	Menu ('Download');
	print ('<h1>Download apoplexy 3.15</h1>');
} else {
	SetRelease ($iRelease);
...
/*****************************************************************************/
{
	switch ($iRelease)
	{
		case 35:
			$sVersion = '3.15';
			$GLOBALS['rdate'] = '2021-05-01';
$GLOBALS['rchanges'] = '+ Added a basic built-in hex editor (F12).';
			break;
		case 34:
			$sVersion = '3.14.1';
			$GLOBALS['rdate'] = '2021-03-31';
$GLOBALS['rchanges'] = '* Better no-down-except-sheath.';
			break;
		case 33:
			$sVersion = '3.14';
			$GLOBALS['rdate'] = '2021-03-21';
$GLOBALS['rchanges'] = '+ PoP1 for DOS autorun and quicker painful falls (F4).
...
$GLOBALS['rchanges'] = '+ It\'s now possible to quickly jump to levels ("l").
...
+ If a newer version of the program exists (has been released), an \'upgrade available\' notice is displayed on the game selection screen.';
		...
		case 30:
			$sVersion = '3.11.1';
			$GLOBALS['rdate'] = '2020-12-30';
$GLOBALS['rchanges'] = '* Fixed a visual bug that was introduced in v3.11 (kid dir).
* Fixed the PoP1 for DOS demo level playability toggle.';
			break;
		case 29:
			$sVersion = '3.11';
			$GLOBALS['rdate'] = '2020-11-23';
$GLOBALS['rchanges'] = '+ A PoP1 for DOS kid screen was added, accessible from the tiles screen ("s"). As yet, it is of no practical use other than modifying P1, and is for testing purposes only. See docs/multiplayer.txt.
* Minor improvements.';
			break;
		case 28:
			$sVersion = '3.10';
			$GLOBALS['rdate'] = '2020-10-15';
$GLOBALS['rchanges'] = '+ Added PoP1 for DOS demo level settings (F4).
...
$GLOBALS['rchanges'] = '+ It\'s now possible to quickly jump to rooms ("j").
...
$GLOBALS['rchanges'] = '+ PoP1 for SNES automatic prince moves can now be modified (F4).';
			break;
		case 23:
			$sVersion = '3.5';
			$GLOBALS['rdate'] = '2019-03-21';
$GLOBALS['rchanges'] = '+ Updated SDLPoP support to v1.19, with 6-bit RGB torch flames.';
			break;
		case 22:
			$sVersion = '3.4';
			$GLOBALS['rdate'] = '2018-06-27';
$GLOBALS['rchanges'] = '+ Most PoP1 for SNES (US/EU) in-game texts can now be modified (F3).';
			break;
		case 21:
			$sVersion = '3.3';
...
<a href="/releases/apoplexy-3.15-win32.zip" class="download">Download Now</a>
</span>
...
<a href="/releases/apoplexy-3.15.tar.gz" class="download">Download Now</a>
</span>
